...
class DownloadFolderName extends StatefulWidget {
  @override
  _DownloadFolderNameState createState() => _DownloadFolderNameState();
}

class _DownloadFolderNameState extends State<DownloadFolderName> {
  String progress = "0";
